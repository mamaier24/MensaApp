package de.hsulm.mensaapp.SQL_OPERATIONS.SQL_SEARCH_BY_DATEID;
...
public class DatabaseOperationsDateID {
    ...
    public void getFoodFromDBbyDateID(final String searchQuery, final IDatabaseOperationsDateID callback) {
